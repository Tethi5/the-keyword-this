...
/*to call on the context of a particular function. In other words the function is the power source and the
.this key opens a pathway to use that source on a seperate return.
      //Answer
...
.apply = array of paramaters (alot of data use this)
.call = individual parameters (less data u use this one.)
      //Answer

  // 4) What does .bind do?
.bind permanetly binds the certain parameters to the function in which you can call on later.
      //Answer
...
//object that is being returned from the Car function. You'll also need to use the 'this' keyword properly
...
//Note(no tests)
  //the string 'iliketurtles'//Answer Here

//In the example above, what is the 'this keyword' bound to when getMyUsername runs?

  //it is bound to the object MyUser--
